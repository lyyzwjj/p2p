...
<link type="text/css" rel="stylesheet"
	href="/js/plugins/uploadifive/uploadifive.css" />
<script type="text/javascript"
	src="/js/plugins/uploadifive/jquery.uploadifive.min.js"></script>
...
<script type="text/javascript">
	$(function() {
		...
		$(".auditClass").click(function(){
			...
			console.log(json);
			$("#id").val(json.id);
			$("#username_au").text(json.username);
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<form id="searchForm" class="form-inline" method="post"
					...
					<script>
						$("#sel_state option[value=${(qo.state)!""}]").prop("selected",true);
					</script>
					<div class="form-group">
						<label>申请时间</label> <input class="form-control" type="text" style="width: 130px;
							name="beginDate" id="beginDate"
							value='${(qo.beginDateDisplay)!""}' />到 <input
							class="form-control" type="text" name="endDate" id="endDate" style="width: 130px;
							value='${(qo.endDateDisplay)!""}' />
					</div>
					<div class="form-group">
						<label>预约用户</label> <input class="form-control"
							style="width: 130px;" type="text" name="username" id="username"
							value="${qo.username!''}" />
					</div>
					<div class="form-group">
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td><#if (info.state== 0)> <a
										href="javascript:void(-1);" class="auditClass"
										data-json='${info.jsonString}'>审核</a> </#if></td>
							</tr>
							</#list>
						</tbody>
					</table>
						...
						<form class="form-horizontal" id="editform" method="post"
							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<label class="form-control" name="username" id="username_au"></label>
									</div>
