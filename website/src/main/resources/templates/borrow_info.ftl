        ...
        <#if bidRequest.bidRequestState==2>
            ...
            <#elseif account??>
                ...
                <input id="minBidAmount" autocomplete="off" value="${bidRequest.minBidAmount?string('0.##')}"
                       type="hidden"/>
                <input id="maxBidAmount" autocomplete="off" value="${bidRequest.remainBidAmount?string('0.##')}"
                       type="hidden"/>
